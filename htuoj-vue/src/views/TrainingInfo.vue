  ...
  <div style="width: 1600px; margin: 0 auto">
    <el-main>
      <div style="display: flex; justify-content: space-between">
        <el-card style="width: 45%; height: 100%">
          <div style="display: flex">
            <el-tabs
              ...
              type="card"
              style="width: 800px; font-size: 18px">
              <el-tab-pane label="官方推荐" name="official"> </el-tab-pane>
              <el-tab-pane label="用户分享" name="userShare"> </el-tab-pane>
              <el-table
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <el-progress
                      ...
                      :text-inside="true"
                      :stroke-width="20"
                      :percentage="scope.row.completionRate"></el-progress>
                  </template>
                </el-table-column>
                <el-table-column
                  prop="problemCount"
        ...
        <el-card style="width: 54%; height: 100%"
          ><div style="display: flex">
            <el-tabs
              ...
              <el-tab-pane label="题单简介" name="trainingProfile">
                <div>
                  <div
                    ...
                    ">
                    {{ trainingOneInfo.title }}
                    <span
                      @click="collect(trainingOneInfo.trainingId)"
                      v-if="trainingOneInfo.isCollect"
                      style="
                        color: #ffa116;
                        display: flex;
                        justify-content: center;
                    ...
                    <div style="margin-left: auto; display: flex; align-items: center;">
                      ...
                      <el-link
                        style="
                          ...
                          color: #3172cc;
                        "
                        :href="'/home/stuInfo/' + trainingOneInfo.userId"
                        target="_blank"
                        :underline="false"
                        >{{ trainingOneInfo.userName }}</el-link
                      >
                    </div>
                  </div>
                  <div>
...
export default {
  data() {
    return {
      cherry: null,
      activeNameLeft: "official",
      activeNameRight: "trainingProfile",
      trainingList: null,
      trainingOneInfo: null,
      totalLeft: 0,
      totalRight: 0,
      formData: {
        current: 1,
  ...
  updated() {
    this.initChart();
    // if (this.liquidChart == null) {
    //   const config = {
    //     percent: this.trainingOneInfo.completionRate / 100,
    //     style: {
    //       outlineBorder: 4,
    //       outlineDistance: 8,
    //       waveLength: 128,
    ...
    //     autoFit: false,
    //   };
    //   this.liquidChart = new Liquid("container", config);
    ...
    if (this.cherry == null) {
      this.cherry = new Cherry({
        id: "markdown",
        value: this.trainingOneInfo.description,
        themeSettings: {
      ...
      this.cherry.setMarkdown(this.trainingOneInfo.description);
    }
  },
  methods: {
    collect(trainingId) {
      this.trainingOneInfo.isCollect = !this.trainingOneInfo.isCollect;
      api
    ...
    initChart() {
      ...
      //   title: {
      //     text: "题单统计",
      //     subtext: "总共" + this.trainingOneInfo.problemCount + "道",
      ...
      //       data: [
      //         {
      //           value: this.trainingOneInfo.easyCount,
      //           name: "简单" + this.trainingOneInfo.easyCount,
      //         },
      //         {
      //           value: this.trainingOneInfo.mediumCount,
      //           name: "中等" + this.trainingOneInfo.mediumCount,
      //         },
      //         {
      //           value: this.trainingOneInfo.hardCount,
      //           name: "困难" + this.trainingOneInfo.hardCount,
      //         },
      //       ],
      //       emphasis: {
      //         label: {
      ...
      if (this.myChartLeft == null)
        this.myChartLeft = echarts.init(document.getElementById("chartLeft"));
      this.updateChart();
    },
    updateChart() {
      const optionLeft = {
      ...
      this.myChartLeft.setOption(optionLeft);
    },
    generateLink(userId) {
      return "/problem/" + userId;
    },
    handleCurrentChangeLeft(current) {
    ...
    async getOfficialTrainingList() {
      await api.getOfficialTrainingList(this.formData).then((response) => {
        this.trainingList = response.data.data.records;
        this.totalLeft = response.data.data.total;
        this.trainingId = this.trainingList[0].trainingId;
        this.trainingOneInfo = this.trainingList[0];
      });
    },
    handleClickLeft(tab) {
