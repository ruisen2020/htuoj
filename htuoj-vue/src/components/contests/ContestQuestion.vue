            ...
            <el-tab-pane class="pane" name="first">
                ...
                ">
                    ...
                    <div style="display: flex; gap: 5px; margin-top: 10px">
                        ...
                        <el-tag size="medium" type="info">时间限制:{{ problemInfo.timeLimit }} ms
                        </el-tag>
                        <el-tag size="medium" type="info">空间限制:{{ problemInfo.memoryLimit }} MB
                        </el-tag>
                        <el-tag size="medium" type="info">提交:{{ problemInfo.submitCount }}
                        </el-tag>
                        <el-tag size="medium" type="info">通过：{{ problemInfo.acceptCount }}
                        </el-tag>
                        <span v-for="(item, index) in problemInfo.labelList" :key="index">
                            <el-tag size="medium" type="info">{{ item }}</el-tag>
                        </span>
                    </div>
                    <div style="margin-top: 20px" id="problemDescriptionMarkdown" class="markdown"></div>
                  ...
                  ">
                      ...
                      ">
                                        ...
                                        <div>
                                            <el-button type="info" size="mini" plain round class="copy-btn"
                                    ...
                                    <div :id="`sampleInput${index}`" v-html="item.sampleInput"
                      ...
                      ">
                                    ...
                                    <div :id="`sampleOutput${index}`" v-html="item.sampleOutput"
                                        style="margin-top: 10px; white-space: pre-wrap"></div>
                                </el-card>
                            </div>
                        </div>
                    ...
                    <div>
                        <div style="font: 20px sans-serif; font-weight: 600; margin-top: 20px">
                            提示信息
                        </div>
                        <div>
        ...
        <el-tab-pane class="pane" name="sixth">
          ...
          <AIAssistant
            ...
            <el-tab-pane class="pane" name="fourth">
                ...
                <SubmissionList v-if="activeName == 'fourth'" @click-event="handleClickRow"></SubmissionList>
            </el-tab-pane>
...
import SubmissionList from "../problem/SubmissionList.vue";
