    ...
    <el-card style="margin-top: 10px">
      <div>
        <div style="height: 24px; display: flex; align-items: center">
          <div style="cursor: pointer" @click="skipUser(commentInfo.userId)">
            <el-avatar
              ...
              style="width: 24px; height: 24px"></el-avatar>
          </div>
          <div
            style="
              font-size: 16px;
        ...
        <div style="height: 30px; display: flex">
          ...
          <el-popconfirm
            title="您确定删除该评论吗？"
            v-if="userInfo != null && userInfo.userId === commentInfo.userId"
            style="display: flex; justify-content: center; align-items: center"
            @confirm="deleteComment(commentInfo.commentId)">
            <div
              slot="reference"
              style="
                display: flex;
          ...
          <div
            style="
              ...
              margin-left: auto;
            ">
            <el-button size="mini" icon="el-icon-edit" @click="toggleModal"
              >回复评论</el-button
            >
          </div>
        </div>
      ...
      <div v-if="openComment">
        <div v-for="item in commentChildList" :key="item.commentId">
          <ChildCommentInfo
            ...
            :parentCommentId="commentInfo.commentId"></ChildCommentInfo>
        </div>
      </div>

      <DialogMarkdown
        :commentInfo="commentInfo"
        :dialogMarkdonwVisible="dialogMarkdonwVisible"
        @toggleModal-event="toggleModal"></DialogMarkdown>
    </el-card>
  </div>
</template>
...
<style scoped>
::v-deep .commentApp > .cherry.theme__light .cherry-previewer {
